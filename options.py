...
def parse_args(script):
    ...
    parser.add_argument('--method'      , default='baseline',   help='baseline/baseline++/maml{_approx}/metasgd/reptile') #relationnet_softmax replace L2 norm with softmax to expedite training, maml_approx use first-order approximation in the gradient for efficiency
    ...
    if script == 'train':
        ...
        parser.add_argument('--dropout_p'     , default=0, type=float,   help='')
